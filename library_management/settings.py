...
# Configure The CustomUser Model
...
# Ensures that all requests made over HTTP are automatically redirected to HTTPS.
SECURE_SSL_REDIRECT = config('SECURE_SSL_REDIRECT', default=False, cast=bool)

# This ensures that the browser always connects via HTTPS.
